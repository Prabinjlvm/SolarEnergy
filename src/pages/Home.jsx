...
export default function Home() {
  return (
      ...
      <div className="it-offcanvas-area">
        <div className="itoffcanvas">
          ...
          <div className="itoffcanvas__text">
            <p>
              Suspendisse interdum consectetur libero id. Fermentum leo vel orci porta non. Euismod viverra nibh cras pulvinar
              suspen.
            </p>
          </div>
          ...
          <div className="itoffcanvas__info">
            ...
            <div className="it-info-wrapper mb-20 d-flex align-items-center">
              ...
              <div className="itoffcanvas__info-address">
                <span>Location</span>
                <a href="https://googleusercontent.com/maps.google.com/0" target="_blank">
    ...
    <header className="it-header-height">
      {/* header-area-start */}
      <div id="header-sticky" className="it-header-area it-header-ptb it-header-style it-header-style-3 it-header-transparent">
                    ...
                    <ul>
                              ...
                              <div className="col home-img">
                                <div className="home-img-thumb home-img-overly mb-20">
                                  ...
                                  <div className="home-img-btn">
                                    ...
                                    <a className="it-btn-sm" href="index-one-page.html">
                                      <span>
                              ...
                              <div className="col home-img">
                                <div className="home-img-thumb home-img-overly mb-20">
                                  ...
                                  <div className="home-img-btn">
                                    ...
                                    <a className="it-btn-sm" href="index-2-one-page.html">
                                      <span>
                                        <span className="text-1">One Page</span>
                                        <span className="text-2">One Page</span>
                                      </span>
                              ...
                              <div className="col home-img">
                                <div className="home-img-thumb home-img-overly mb-20">
                                  ...
                                  <div className="home-img-btn">
                                    ...
                                    <a className="it-btn-sm" href="index-3-one-page.html">
                                      <span>
                                        <span className="text-1">One Page</span>
                                        <span className="text-2">One Page</span>
                                      </span>
                              ...
                              <div className="col home-img">
                                <div className="home-img-thumb home-img-overly mb-20">
                                  ...
                                  <div className="home-img-btn">
                                    ...
                                    <a className="it-btn-sm" href="index-4-one-page.html">
                                      <span>
                                        <span className="text-1">One Page</span>
                                        <span className="text-2">One Page</span>
                                      </span>
                              ...
                              <div className="col home-img">
                                <div className="home-img-thumb home-img-overly mb-20">
                                  ...
                                  <div className="home-img-btn">
                                    ...
                                    <a className="it-btn-sm" href="index-5-one-page.html">
                                      <span>
                                        <span className="text-1">One Page</span>
                                        <span className="text-2">One Page</span>
                                      </span>
                      ...
                      <li className="has-dropdown">
                        ...
                        <ul className="it-submenu submenu">
                          ...
                          <li>
                            <a href="service-details-no-sidebar.html">Service No Sidebar</a>
                          </li>
                        </ul>
                      </li>
                      <li className="has-dropdown">
                      ...
                      <li className="has-dropdown">
                        ...
                        <ul className="it-submenu submenu">
                          ...
                          <li>
                            <a href="blog-details-no-sidebar.html">Blog No Sidebar</a>
                          </li>
                        </ul>
                      </li>
                      <li>
    ...
    <main className="main-content-start">
      <WindEnergySlider />
      {/* Other components and content for the home page go here */}
    </main>
    </>
