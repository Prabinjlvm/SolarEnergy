...
const WindEnergySlider = () => {
  useEffect(() => {
    ...
    console.log(
      "Swiper slides found by Swiper instance:",
      swiper.slides ? swiper.slides.length : "N/A"
    );
    if (swiper.slides) {
          ...
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide">
              <div className="it-slider-4-box it-slider-4-overlay p-relative">
                ...
                <span className="it-hero-experience">
                  <i>
                    <img
                      src={`${process.env.PUBLIC_URL}/assets/img/hero/favicon.png`}
                      alt=""
                    />
                  </i>
                  <b className="it-hero-experience-text">
                    <img
                      src={`${process.env.PUBLIC_URL}/assets/img/shape/slider-5-2.png`}
                      alt=""
                    />
                  </b>
                </span>
                            ...
                            <div className="col-xl-5 col-lg-6 col-md-5">
                              <div className="it-slider-4-customer-info">
                                ...
                                <div className="it-slider-4-customer-ratting">
                                  ...
                                  >
                                    <path
                                      d="M20 7.72645L12.7329 7.24867L9.99602 0.373047L7.25918 7.24867L0 7.72645L5.56773 12.454L3.7407 19.6255L9.99602 15.6715L16.2514 19.6255L14.4243 12.454L20 7.72645Z"
                                      fill="white"
                                    />
                                  </svg>
                                  <svg
                                  ...
                                  >
                                    <path
                                      d="M12.2686 7.43359L12.3848 7.72656L12.7002 7.74805L18.7324 8.14355L14.1006 12.0723L13.8623 12.2744L13.9395 12.5771L15.4561 18.5312L10.2627 15.249L9.99609 15.0801L9.72852 15.249L4.53516 18.5312L6.05273 12.5771L6.12891 12.2754L5.8916 12.0732L1.26367 8.14453L7.29199 7.74805L7.60742 7.72656L7.72363 7.43359L9.99609 1.72461L12.2686 7.43359Z"
                                      stroke="white"
                                    />
                                  </svg>
                                </div>
            ...
            <div className="swiper-slide">
              <div className="it-slider-4-box it-slider-4-overlay p-relative">
                <div className="it-slider-4-bg">
                  <img
                    src={`${process.env.PUBLIC_URL}/assets/img/slider/slider-5-3.jpg`}
                    alt=""
                  />
                </div>
                <span className="it-hero-experience">
