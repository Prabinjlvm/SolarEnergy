...
const ServiceSection = () => {
  return (
    <>
      {/* service-area-start */}
      <section className="it-service-4-area gray-bg3 pt-130 pb-100">
        <div className="container">
          ...
          <div className="row gx-35">
            ...
            >
              <div className="it-service-4-item text-center mb-30">
                <div className="it-service-4-thumb mb-40">
                  <img src="assets/img/service/service-5-2.png" alt="" />
                </div>
                <div className="it-service-4-content">
                  <h5 className="it-service-4-title mb-20">
            ...
            >
              <div className="it-service-4-item text-center mb-30">
                <div className="it-service-4-thumb mb-40">
                  <img src="assets/img/service/service-5-3.png" alt="" />
                </div>
                <div className="it-service-4-content">
                  <h5 className="it-service-4-title mb-20">
